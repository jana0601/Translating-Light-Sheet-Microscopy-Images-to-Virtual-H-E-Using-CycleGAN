"""
Training script for CycleGAN H&E conversion.
"""
import os
import yaml
import torch
...
def train():
    ...
    schedulers = {
        'G': get_scheduler(optimizer_G, config['training']['num_epochs'], 
                          config['training']['lr_decay_epochs']),
        'D_A': get_scheduler(optimizer_D_A, config['training']['num_epochs'],
                            config['training']['lr_decay_epochs']),
        'D_B': get_scheduler(optimizer_D_B, config['training']['num_epochs'],
                            config['training']['lr_decay_epochs'])
    }
